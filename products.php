...
$paypalID = 'amitshukla291988-facilitator@gmail.com'; //Business Email
...
?>
    ...
    <form action="<?php echo $paypalURL; ?>" method="post">
       ...
       <!--  //ipn, cancel, and return urls
            //$pp['notify_url'] = base_url()."paypal_ipn.php"; //paypal  --><!-- will send data here when the payment is complete -->
